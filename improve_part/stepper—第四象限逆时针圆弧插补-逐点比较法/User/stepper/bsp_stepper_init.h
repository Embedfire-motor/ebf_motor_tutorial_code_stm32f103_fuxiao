...
#define Y_MOTOR_DIR_GPIO_PORT                GPIOD  
#define Y_MOTOR_DIR_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOD_CLK_ENABLE()

//Motor 使能
#define Y_MOTOR_EN_PIN                       GPIO_PIN_13
#define Y_MOTOR_EN_GPIO_PORT                 GPIOC             
#define Y_MOTOR_EN_GPIO_CLK_ENABLE()      	 __HAL_RCC_GPIOC_CLK_ENABLE()
...
//其中 高级定时器的 频率为168MHz,其他定时器为32MHz
